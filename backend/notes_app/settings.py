...
SECRET_KEY = 'django-insecure-+&r9o%!n$im8^osdk%%@z3@(c!%f)&v$vc40tvk^y92xk$#t3p'
...
INSTALLED_APPS = [
    ...
    'authentication',  # Your app for user registration and login
    'notes', 
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': 'your-secret-key',  # Keep this secret!
    'VERIFYING_KEY': None,
